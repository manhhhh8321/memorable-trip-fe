...
import { Box, Button, Icon, InputGroup, InputRightElement, Text, VStack } from '@chakra-ui/react'
...
export const ResetPasswordForm = () => {
  ...
  return !state?.email || !state?.code ? (
    ...
    <VStack as='form' onSubmit={handleSubmit(onSubmit)} w='min(100%, 700px)' spacing={8} p='60px 16px' borderRadius={8}>
      ...
      <Controller
        ...
        render={({ field }) => (
          <Box w='100%'>
            ...
            {errors.confirmPassword && <Text variant='error'>{errors.confirmPassword.message}</Text>}
          </Box>
        )}
      />
